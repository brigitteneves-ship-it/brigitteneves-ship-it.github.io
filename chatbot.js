...
class ChatBot {
    constructor() {
        ...
        this.webhookUrl = 'https://nevesbr.app.n8n.cloud/webhook/chat_webhook_nocal';
                ...
                <div class="chatbot-panel" id="chatbotPanel">
                    ...
                    <div class="chat-messages" id="chatMessages">
                        <div class="message system">
                            Welcome to AI Assistant! I can answer any questions about Brigitte's assignements.
                        </div>
                    </div>
    ...
    loadChatHistory() {
        ...
        if (recentHistory.length === 0) {
            ...
            setTimeout(() => {
                this.addMessage('Hello! I\'m AI Assistant v6. Do you have any questions about Brigitte's assignements?', 'ai');
            }, 1000);
        }
    }
